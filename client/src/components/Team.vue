          ...
          <div class="member table-row" v-for="user in users" :key="user.id">
              ...
              <div class="table-col actions">
                  <div class="button-group group-end">
                      <button class="button button-small button-chat" @click="() => toggleChat(user.id)">Chat</button>
...
export default {
    props: ["users","fetchUsers","toggleForm","toggleChat"],
    setup (props) {
...
.table-row:nth-child(2n+1){
    background-color: var(--ligth-alt);
}
